...
.qcc-result-card {
    background: var(--qcc-card-bg, #ffffff);
    border: 1px solid var(--qcc-color-border, #e5e7eb);
    border-radius: 12px;
    padding: 1.5rem;
 ...
 * - $data['layout'] - Layout-Typ (cards, table, mixed)
 * - $data['live_update'] - Live-Updates aktiviert
 * - $data['show_explanations'] - Erklärungen anzeigen
 * - $data['currency'] - Aktuelle Währung
 * - $data['unit'] - Aktuelle Einheit
 * - $data['results'] - Berechnungs-Ergebnisse
 * - $data['result_cards'] - Custom Card-Konfiguration
 * - $data['loading'] - Loading-Zustand
 * - $data['show_export'] - Export-Button anzeigen
 * - $data['show_last_updated'] - Letzte Aktualisierung anzeigen
 * - $data['show_recommendations'] - Empfehlungen anzeigen
 * - $data['show_benchmarks'] - Industry-Benchmarks anzeigen
 * - $data['show_actions'] - Aktions-Bar anzeigen
 * - $data['show_save_scenario'] - Szenario-Speichern-Button
 * - $data['show_compare'] - Vergleichs-Button
 * - $data['show_print'] - Drucken-Button
 * 
 * Results-Struktur:
 * - total_quality_cost - Gesamt-Qualitätskosten
 * - prevention_cost - Präventionskosten
 * - appraisal_cost - Bewertungskosten
 * - internal_defect_cost - Interne Fehlerkosten
 * - external_defect_cost - Externe Fehlerkosten
 * - cogq_total - COGQ Gesamt
 * - copq_total - COPQ Gesamt
 * - cogq_percentage - COGQ Prozentsatz
 * - copq_percentage - COPQ Prozentsatz
 * - opportunity_cost - Opportunitätskosten
 * - total_impact - Gesamt-Business-Impact
 * - roi_improvement - ROI-Verbesserung
 * 
 * Card-Konfiguration:
 * - label - Card-Titel
 * - value - Anzuzeigender Wert
 * - type - Wert-Typ (currency, percentage, number)
 * - color - Card-Farbe (primary, success, danger, warning, info)
 * - icon - Card-Icon (Emoji oder HTML)
 * - description - Erklärungstext
 * - percentage - Zusätzlicher Prozentsatz
 * - category - Card-Kategorie (cogq, copq, general)
 * - trend - Trend-Information (direction, text)
 * 
 * CSS-Klassen:
 * - .qcc-results-section - Basis-Results-Section
 * - .qcc-result-group - Card-Gruppe
 * - .qcc-result-cards - Cards-Container
 * - .qcc-result-card - Einzelne Result-Card
 * - .qcc-result-card--{color} - Farbige Card-Varianten
 * - .qcc-recommendations - Empfehlungs-Section
 * - .qcc-benchmarks - Benchmark-Section
 * - .qcc-results-actions-bar - Aktions-Buttons
 * 
 * JavaScript-Integration:
 * - QCC.updateResults(results) - Ergebnisse aktualisieren
 * - QCC.toggleExplanations() - Erklärungen ein-/ausblenden
 * - QCC.exportResults() - Ergebnisse exportieren
 * - QCC.saveScenario() - Szenario speichern
 * - QCC.compareScenarios() - Szenarien vergleichen
 * - QCC.printResults() - Ergebnisse drucken
 * - QCC.generateReport() - Detaillierten Report erstellen
 * 
 * Live-Update Features:
 * - Automatische Wert-Updates bei Form-Änderungen
 * - Animierte Wert-Übergänge
 * - Live-Indikator mit Puls-Animation
 * - Timestamp-Updates
 * - Dynamic Recommendations basierend auf Werten
 * 
 * Accessibility:
 * - role="region" für Section
 * - Semantic HTML-Struktur
 * - aria-label für alle interaktiven Elemente
 * - Screen-Reader-freundliche Wert-Updates
 * - Keyboard-Navigation-Support
 * 
 * Performance:
 * - Template-Caching automatisch
 * - CSS Grid für optimale Card-Layouts
 ...
 * - Stacked Actions auf Mobile
 * - Touch-friendly Button-Sizing
 * - Print-Stylesheet für Reports
 */
?>